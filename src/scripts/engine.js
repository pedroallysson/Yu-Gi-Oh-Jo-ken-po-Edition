...
const state = {
    ...
    actions: {
        buttton: document.getElementById("next-duel"),
    }
};
...
async function drawButton(text) {
    state.actions.buttton.innerText = text;
    state.actions.buttton.style.display = "block";
}
...
async function resetDuel() {
    state.cardSprites.avatar.src = "";
    state.actions.buttton.style.display = "none";
